...
export const env = {
  ...
  ADMIN_PASSWORD: process.env.ADMIN_PASSWORD || 'admin_secret_2024',

  // Fraud / Security
  FRAUD_BLOCKED_IPS: process.env.FRAUD_BLOCKED_IPS || '',

  // Payment
  DEFAULT_PAYMENT_GATEWAY: process.env.DEFAULT_PAYMENT_GATEWAY || 'mercadopago',
